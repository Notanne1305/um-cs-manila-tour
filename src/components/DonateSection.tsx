import { Heart, Smartphone, Shield, Sparkles, Copy, Check } from "lucide-react";
...
const DonateSection = () => {
  ...
  const copyNumber = () => {
    navigator.clipboard.writeText("09380369397");
    setCopied(true);
    ...
    <section id="donate" className="py-24 md:py-32 bg-gradient-to-b from-secondary/30 via-secondary/50 to-secondary/30 relative overflow-hidden">
      ...
      <div className="container relative">
        ...
        <div className="max-w-md mx-auto">
          <div className="bg-card rounded-3xl shadow-medium overflow-hidden border border-border/50 relative">
            {/* Header */}
            <div className="bg-gradient-to-br from-primary via-primary to-primary/80 p-6 text-center relative overflow-hidden">
              ...
              <div className="relative inline-flex items-center gap-3 bg-white/20 backdrop-blur-sm px-5 py-2.5 rounded-full">
                ...
                <span className="text-primary-foreground font-semibold">GCash Donation</span>
              </div>
            </div>
            ...
            <div className="p-8">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-sm text-muted-foreground mt-3">
                  Account Name: <span className="font-semibold text-foreground">Jonathan Sindo</span>
                </p>
              </div>
          ...
          <div className="mt-8 text-center">
            <div className="inline-flex items-center gap-2 text-primary bg-primary/10 px-6 py-3 rounded-full">
