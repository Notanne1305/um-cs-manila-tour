      ...
      <div className="container relative">
        <div className="text-center mb-16 md:mb-20 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <h2 className="font-display text-3xl md:text-4xl lg:text-5xl text-foreground mb-6">
            Educational Tour to <span className="text-primary relative">
              Manila
              <span className="absolute -bottom-1 left-0 right-0 h-1 bg-gradient-to-r from-primary to-accent rounded-full" />
            </span>
          </h2>
